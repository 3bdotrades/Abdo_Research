  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-gray-950">
      <div className="text-center max-w-sm px-6">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Upgrade to access the dashboard</h2>
        <p className="text-gray-400 text-sm mb-6 leading-relaxed">
          Upgrade to <strong className="text-white">Pro</strong> or{' '}
          <strong className="text-white">VIP+</strong> to unlock real-time signals,
          portfolio analytics, and full signal history.
        </p>
  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-gray-950">
      <div className="text-center max-w-sm px-6 card border-yellow-800/40 bg-yellow-900/10">
        ...
        <h2 className="text-lg font-bold text-white mb-2">Dashboard not configured</h2>
        <p className="text-gray-400 text-sm leading-relaxed">
          Set{' '}
          <code className="text-yellow-300 bg-gray-800 px-1.5 py-0.5 rounded">VITE_DASHBOARD_URL</code>{' '}
          in your <code className="text-yellow-300 bg-gray-800 px-1.5 py-0.5 rounded">.env</code> file.
        </p>
      </div>
    </div>
  )
