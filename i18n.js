(function () {
  ...
  var entries = [
    ["عبدالرحمن محمد | باحث كمي", "Abdulrhman Mohamed | Market Research and Educational Signals"],
    ["عبدالرحمن محمد — باحث كمي. أبحاث وأدوات تداول لإدارة مخاطر الصفقات والمحافظ عبر اختبارات خارج العينة وقياس منضبط للأداء.", "Abdulrhman Mohamed — research, trading tools, and educational signals for managing trade and portfolio risk through out-of-sample testing and disciplined performance measurement."],
    ["أبحاث وإشارات تعليمية وأدوات تداول لإدارة الصفقات والمحافظ، ضبط المخاطر، وقياس الأداء خارج العينة.", "Research, educational signals, and trading tools for managing trades and portfolios, controlling risk, and measuring out-of-sample performance."],
    ["عبدالرحمن محمد | باحث كمي مستقل · تداول منهجي", "Abdulrhman Mohamed | Research and Educational Trading Signals"],
    ["عبدالرحمن محمد — باحث كمي. أبحاث نماذج تداول وأدوات للمتداول اليدوي وإدارة مخاطر الصفقات والمحافظ.", "Abdulrhman Mohamed — trading model research, educational signals, and tools for discretionary traders and trade/portfolio risk management."],
    ["404 — الصفحة غير موجودة | عبدالرحمن محمد", "404 — Page Not Found | Abdulrhman Mohamed"],
    ["تواصل معي | عبدالرحمن محمد", "Contact Me | Abdulrhman Mohamed"],
    ...
    ["الأسئلة الشائعة | عبدالرحمن محمد", "FAQ | Abdulrhman Mohamed"],
    ...
    ["لوحة التحكم | عبدالرحمن محمد", "Dashboard | Abdulrhman Mohamed"],
    ["لوحة", "Dashboard"],
    ["لوحة عبدالرحمن محمد", "Abdulrhman Mohamed Dashboard"],
    ["لوحة عبدالرحمن محمد — متابعة المحافظ", "Abdulrhman Mohamed — Portfolio Workstation"],
    ["مساحة تشغيلية لمتابعة التعرض، الربح والخسارة، المخاطر، والمراجعة اليومية. تفعيل الربط يتم بعد تحديد نطاق المحفظة والاتفاق.", "An operating workspace for exposure, P&L, risk, and daily review. Connection is activated after the portfolio scope and agreement are defined."],
    ["غير مفعل", "Inactive"],
    ["محطة متابعة المحفظة", "Portfolio monitoring terminal"],
    ["تفعيل متابعة المحفظة", "Activate portfolio monitoring"],
    ["هذا الجزء يُفعّل بعد مناقشة رأس المال، نسبة الإدارة أو المشاركة، الاستراتيجية، حدود المخاطر، وطريقة التقارير. الهدف أن تكون المتابعة عملية وليست صفحة تسويق.", "This area is activated after discussing capital, management or participation percentage, strategy, risk limits, and reporting workflow. The goal is an operating monitor, not a marketing page."],
    ["ناقش نطاق المحفظة", "Discuss Portfolio Scope"],
    ["مصفوفة التعرض", "Exposure Matrix"],
    ["السوق", "Market"],
    ["التعرض", "Exposure"],
    ["المخاطر", "Risk"],
    ["الحالة", "State"],
    ...
    ["تحقق", "Validate"],
    ["مجمّد", "Frozen"],
    ["ميزانية المخاطر", "Risk Budget"],
    ["المخاطرة اليومية", "Daily Risk"],
    ["التعرض المفتوح", "Open Exposure"],
    ["مخاطر السوق الواحد", "Single-Market Risk"],
    ["الأرقام هنا شكل واجهة قبل الربط. بعد التفعيل يتم تحديثها من بيانات المحفظة أو دفتر الصفقات.", "These figures are interface placeholders before connection. After activation, they update from portfolio data or the trade blotter."],
    ["الرمز", "Ticker"],
    ["النوع", "Type"],
    ["الوزن", "Weight"],
    ["الدخول", "Entry"],
    ["المراجعة", "Review"],
    ["بعد التفعيل", "After Activation"],

    ["أبحاث", "Research"],
    ["كمية", "Quant"],
    ["أبحاث وإشارات تعليمية · الأسواق المالية", "Research and Educational Signals · Financial Markets"],
    ...
    ["اختر القناة المناسبة لاستفسارك. جلسات 1v1 المدفوعة مخصصة للتدريب والتحليل والاستشارة، أما مكالمة إدارة المحفظة المجانية فهي لتقييم النطاق قبل أي اتفاق.", "Select the appropriate channel for your inquiry. Paid 1v1 sessions are for coaching, analysis, and consultation, while the free portfolio-management call is for scoping the mandate before any agreement."],
    ["حجز مكالمة", "Schedule a Call"],
    ["احجز جلسة 1v1 بسعر 50 دولار لكل ساعة للتدريب أو التحليل أو الاستشارة، أو مكالمة مجانية لمدة 20 دقيقة لمناقشة إدارة محفظة ورأس المال ونسبة الاتفاق والمخاطر.", "Book a 1v1 session at $50 per hour for coaching, analysis, or consultation, or a free 20-minute call to discuss portfolio management, capital, fee percentage, and risk."],
    ["احجز جلسة", "Book a Session"],
    ["تواصل مباشرة لتفعيل لوحة الأبحاث والإشارات، أسئلة الاشتراك، الوصول للحساب، أو المواد التعليمية والبحثية المنشورة.", "Message directly for research-and-signals dashboard activation, subscription questions, account access, or published educational and research material."],
    ["راسلني على تيليجرام", "Message on Telegram"],
    ["المحتوى العام لأغراض بحثية وتعليمية فقط ولا يمثل نصيحة استثمارية أو ضماناً للعوائد. إدارة المحافظ خدمة منفصلة قد تشمل نصيحة استثمارية بعد اتفاق مكتوب.", "Public content is for research and education only and is not investment advice or a return guarantee. Portfolio management is a separate service that may include investment advice after a written agreement."],
    ...
    ["ابدأ من مجتمع تيليجرام المجاني، أو اطلب لوحة الأبحاث والإشارات عبر تيليجرام، أو احجز جلسة 1v1 بسعر 50 دولار للساعة، أو مكالمة مجانية لمدة 20 دقيقة لمناقشة إدارة محفظة.", "Start with the free Telegram community, request the research-and-signals dashboard through Telegram, book a 1v1 session at $50/hour, or schedule a free 20-minute call to discuss portfolio management."],
    ["مجاني", "Free"],
    ...
    ["لوحة الأبحاث والإشارات", "Research and Signals Dashboard"],
    ["خطة الأبحاث والإشارات", "Research and Signals Plan"],
    ["وصول إلى لوحة الأبحاث والإشارات، مكتبة الفيديو، وسجل القراءات حسب الأسواق التي تختارها. يتم تفعيل الحساب عبر تيليجرام.", "Access the research-and-signals dashboard, video library, and market readings for the markets you choose. Account activation is handled through Telegram."],
    ["تواصل على تيليجرام", "Message on Telegram"],
    ["استشارة 1v1", "1v1 Consultation"],
    ["جلسة تدريب وتحليل 1v1", "1v1 Coaching and Analysis Session"],
    ["50 دولار / ساعة", "$50 / hour"],
    ["جلسة مدفوعة للتدريب، التحليل، مراجعة أفكارك، أو استشارة مباشرة حول السوق وطريقة استخدام الأدوات.", "A paid session for coaching, analysis, reviewing your ideas, or direct consultation around the market and tool workflow."],
    ["تدريب وتحليل مخصص", "Personalized coaching and analysis"],
    ["مراجعة فكرة أو سوق محدد", "Review a specific idea or market"],
    ["استشارة مباشرة حسب احتياجك", "Direct consultation based on your need"],
    ["احجز جلسة 1v1", "Book a 1v1 Session"],
    ["إدارة محفظة", "Portfolio Management"],
    ["إدارة المحفظة", "Portfolio Management"],
    ["مكالمة مجانية لمدة 20 دقيقة لمناقشة رأس المال، نسبة الإدارة أو المشاركة، الاستراتيجية، وحدود المخاطر قبل أي اتفاق.", "A free 20-minute call to discuss capital, management or performance percentage, strategy, and risk limits before any agreement."],
    ["تحديد أهداف المحفظة ورأس المال", "Define portfolio objectives and capital"],
    ["مناقشة نسبة الإدارة أو المشاركة", "Discuss management or performance percentage"],
    ["نطاق مكتوب قبل أي إدارة فعلية", "Written scope before any active management"],
    ["احجز مكالمة مجانية", "Book a Free Call"],
    ["خطط قابلة للتخصيص حسب نطاق العمل.", "Custom plans based on scope."],
    ["اختر بين الوصول إلى لوحة الأبحاث والإشارات أو نطاق متابعة المحفظة. التسعير النهائي يعتمد على الأسواق، عدد الأدوات، وتكرار المراجعة المطلوبة.", "Choose between research-and-signals dashboard access or a portfolio-management scope. Final pricing depends on markets, number of tools, and required review cadence."],
    ["خطة لوحة البيانات", "Dashboard Plan"],
    ["وصول إلى لوحة الأبحاث والإشارات، مكتبة الفيديو، وسجل القراءات حسب الأسواق التي تختارها.", "Access the research-and-signals dashboard, video library, and market readings for the markets you choose."],
    ...
    ["خطة إدارة المحفظة", "Portfolio Management Plan"],
    ["إطار مخصص لمتابعة التعرض، المخاطر، ومراجعة القرارات على مستوى المحفظة.", "A customized framework for portfolio exposure, risk, and decision review."],
    ["تحديد ميزانية المخاطر", "Define risk budget"],
    ["مراجعات دورية للصفقات والمراكز", "Periodic trade and position reviews"],
    ["تقارير بحثية حسب نطاق المحفظة", "Research reports by agreed portfolio scope"],
    ...
    ["اطلب الوصول إلى الأبحاث والإشارات والفيديو", "Request access to research, signals, and video"],
    ...
    ["باحث كمي · خبرة أكثر من 8 سنوات", "Market Research · 8+ Years of Experience"],
    ["أبحاث وأدوات تداول لبناء قرارات قابلة للقياس", "Research, Signals, and Trading Tools for Measurable Decisions"],
    ...
    ["أي تكاليف خاصة بمنصة التداول، البيانات، العمولات، أو تنفيذ الصفقات تكون خارج الموقع وخارج المحتوى البحثي. دوري هو توضيح الفكرة والمخاطر، وليس إدارة حسابات أو تنفيذ أوامر.", "Any costs related to trading platforms, data, commissions, or execution are outside the public site and research content. Any portfolio-management scope must be agreed separately in writing."],
    ["هل يوجد حد أدنى لحجم الحساب؟", "Is there a minimum account size?"],
    ["لا أضع حداً عاماً داخل الموقع لأن الهدف ليس إدارة أموال. لكن حجم الحساب مهم عند تطبيق أي فكرة، لأن العمولات، حجم الصفقة أو المركز، وحالة المحفظة ككل قد تجعل نفس الفكرة مناسبة لشخص وغير مناسبة لشخص آخر.", "The public site does not set a general minimum. Account size still matters because commissions, position size, and total portfolio condition can make the same idea suitable for one person and unsuitable for another."],
    ...
    ["للاستفسارات المهنية أو طلب الوصول إلى الأبحاث، اختر القناة المناسبة. المكالمة التعريفية مخصصة لفهم احتياجك البحثي ونطاق الأسواق محل الاهتمام، وليست جلسة توصيات أو إدارة أموال.", "For professional inquiries or research access requests, choose the right channel. Public research discussions are for understanding your needs and markets of interest. Portfolio management is handled separately under a written scope."],
    ["مكالمة تعريفية قصيرة لمناقشة نطاق الأبحاث والإشارات، أسلوب إدارة المخاطر، وطريقة استخدام لوحة الأبحاث والإشارات.", "A short introductory call to discuss research and signals scope, risk management style, and how to use the research-and-signals dashboard."],
    ...
    ["تشغيل الحساب وتحديد صلاحية الوصول إلى لوحة الأبحاث والإشارات.", "Operate the account and determine access permission to the research-and-signals dashboard."],
    ...
    ["جميع المحتويات لأغراض بحثية وتعليمية ولا تُعد نصيحة استثمارية أو توصية تداول أو عرضاً لإدارة أموال. الأداء السابق لا يضمن نتائج مستقبلية.", "Public content is produced for research and educational purposes only. It is not investment advice, a trading recommendation, or a return guarantee. Any portfolio-management scope requires a separate written agreement."],
    ...
    ["جميع المحتويات لأغراض بحثية وتعليمية ولا تُعد نصيحة استثمارية أو توصية تداول.", "Public content is produced for research and educational purposes only and is not investment advice or a trading recommendation."],

    ["عبدالرحمن محمد | أبحاث وإشارات تعليمية للتداول", "Abdulrhman Mohamed | Research and Educational Trading Signals"],
    ["عبدالرحمن محمد — أبحاث، أدوات تداول، وإشارات تعليمية لإدارة مخاطر الصفقات والمحافظ عبر اختبارات خارج العينة وقياس منضبط للأداء.", "Abdulrhman Mohamed — research, trading tools, and educational signals for managing trade and portfolio risk through out-of-sample testing and disciplined performance measurement."],
    ["أبحاث، أدوات تداول، وإشارات تعليمية لإدارة الصفقات والمحافظ، ضبط المخاطر، وقياس الأداء خارج العينة.", "Research, trading tools, and educational signals for managing trades and portfolios, controlling risk, and measuring out-of-sample performance."],
    ["عبدالرحمن محمد · أبحاث وإشارات تعليمية", "Abdulrhman Mohamed · Research and Educational Signals"],
    ["عبدالرحمن محمد — أبحاث نماذج تداول، إشارات تعليمية، وأدوات للمتداول اليدوي وإدارة مخاطر الصفقات والمحافظ.", "Abdulrhman Mohamed — trading model research, educational signals, and tools for discretionary traders and trade/portfolio risk management."],
    ["أبحاث وإشارات تداول تعليمية لبناء قرارات قابلة للقياس", "Research and Educational Trading Signals for Measurable Decisions"],
    ["أطوّر أطر بحث، نماذج تداول، وإشارات تعليمية تُعامل السوق كمسألة احتمالات لا كوعود. يبدأ العمل من الفرضية، يمر عبر اختبار خارج العينة، ثم يُترجم إلى قراءة أو إشارة قابلة للمراجعة مع حجم الصفقة أو المركز، حدود المخاطر، ومراجعة الأداء.", "I develop research frameworks, trading models, and educational signals that treat markets as probabilities, not promises. The process starts with a hypothesis, passes through out-of-sample testing, then becomes a reviewable reading or signal with trade/position size, risk limits, and performance review."],
    ["من الفرضية البحثية إلى إشارة أو قاعدة تداول قابلة للمراجعة.", "From research hypothesis to a reviewable signal or trading rule."],
    ["تحويل النتائج إلى إشارة تعليمية أو قواعد تنفيذ: حجم صفقة أو مركز، حدود خسارة، شروط دخول وخروج.", "Turn results into an educational signal or execution rules: trade or position size, loss limits, and entry/exit conditions."],
    ["ثلاث ركائز قبل أي إشارة أو قرار تداول.", "Three pillars before any signal or trading decision."],
    ["إطار بحثي يوازن بين حالة الاقتصاد الكلي، جودة البيانات المالية، سلوك السعر، والانضباط في تخصيص رأس المال قبل نشر أي قراءة أو إشارة تعليمية.", "A research framework balancing the macro backdrop, financial data quality, price behavior, and capital discipline before publishing any reading or educational signal."],
    ["كل نموذج أو إشارة يبدأ بسؤال قابل للقياس، لا بانطباع بصري. يبدأ التحليل من الاقتصاد الكلي، ثم مالية الشركات أو العملات، ثم سلوك السعر عبر بيئات سوق مختلفة.", "Every model or signal starts with a measurable question, not a visual impression. Analysis begins with macro conditions, then company or currency financials, then price behavior across market regimes."],
    ["متابعة بحثية وإشارات", "Research and Signals Follow-Up"],
    ["إدارة الإشارة والصفقة", "Signal and Trade Management"],
    ["الإشارة لا تقف عند نقطة الدخول. يتم تحديد المخاطر حسب الصفقة أو المركز وحالة المحفظة ككل، مع شروط واضحة للخروج أو بطلان الفرضية.", "A signal does not stop at entry. Risk is defined by the trade or position and the state of the whole portfolio, with clear exit and invalidation conditions."],
    ["المنهجية موجّهة لمن يريد قراءة الأسواق من منظور صفقة ومخاطر ومحفظة، لا من منظور مطاردة إشارات أو توصيات سريعة.", "The methodology is for people who want to read markets through trades, risk, and portfolios, not by chasing signals or quick recommendations."],
    ["تحتاج إلى أدوات وقراءات وإشارات تعليمية تساعدك على فهم السياق، مستويات بطلان الفكرة، وإدارة الصفقة قبل التنفيذ.", "You need tools, readings, and educational signals that clarify context, invalidation levels, and trade management before execution."],
    ["قراءات وتنبيهات بحثية قبل الدخول أو الخروج", "Research readings and alerts before entry or exit"],
    ["أبحاث، إشارات، ورؤى السوق", "Research, Signals, and Market Insights"],
    ["قراءات وإشارات تعليمية أُعدّها بنفسي تبدأ من الاقتصاد الكلي، ثم الحالة المالية للشركات أو العملات، ثم سلوك السعر، مع فصل واضح بين التحليل البحثي وقرار التنفيذ.", "Readings and educational signals I prepare myself, starting with macro conditions, then company or currency financial condition, then price behavior, with a clear separation between research analysis and execution decisions."],
    ["إشارة تعليمية", "Educational Signal"],
    ["مبادئ إدارة البحث والإشارات والمخاطر", "Research, Signals, and Risk Principles"],
    ["القيم التي تحكم عملية البحث والإشارة واتخاذ القرار: قابلية القياس، وضوح الافتراضات، والانضباط أمام المخاطر.", "The values behind research, signals, and decision-making: measurability, clear assumptions, and discipline around risk."],
    ["تُعرض النتائج والإشارات مع فترات التراجع والافتراضات المستخدمة. الهدف هو فهم المخاطر لا تسويق رقم منفرد.", "Results and signals are shown with drawdown periods and assumptions used. The goal is to understand risk, not market a single number."],
    ["منهجية البحث والإشارة", "Research and Signal Methodology"],
    ["نُخضع كل فرضية أو إشارة لتسلسل واضح: اقتصاد كلي، حالة مالية، سلوك سعر، ثم إطار مخاطر قابل للمراجعة.", "Every hypothesis or signal goes through a clear sequence: macro conditions, financial condition, price behavior, then a reviewable risk framework."],
    ["إدارة المخاطر قبل الإشارة", "Risk Before the Signal"],
    ["كيف تتحول الفكرة إلى بحث أو إشارة قابلة للاستخدام؟", "How does an idea become usable research or signal?"],
    ["إطار عمل واضح يشبه طريقة فرق التداول والبحث المهنية: سؤال محدد، بيانات قابلة للمراجعة، قواعد مخاطر، إشارة تعليمية، ثم متابعة دورية.", "A clear workflow similar to professional trading and research teams: a defined question, reviewable data, risk rules, an educational signal, then periodic monitoring."],
    ["النشر والإشارة والمتابعة", "Publish, Signal, and Monitor"],
    ["عندما تصبح القراءة واضحة، تتحول إلى بحث أو إشارة تعليمية أو فيديو داخل المكتبة، ثم تتم مراجعتها عند تغير ظروف السوق.", "When the reading is clear, it becomes research, an educational signal, or a video in the library, then gets reviewed when market conditions change."],
    ["مسارات واضحة للأبحاث والإشارات والتعليم.", "Clear paths for research, signals, and education."],
    ["ابدأ من مجتمع تيليجرام المجاني، أو اطلب لوحة الأبحاث والإشارات عبر تيليجرام، أو احجز جلسة 1v1 بسعر 50 دولار للساعة، أو مكالمة مجانية لمدة 20 دقيقة لمناقشة إدارة محفظة.", "Start with the free Telegram community, request the research-and-signals dashboard through Telegram, book a 1v1 session at $50/hour, or schedule a free 20-minute call to discuss portfolio management."],
    ["متابعة مجانية للإعلانات العامة، تحديثات الأبحاث، وبعض الإشارات والتنبيهات التعليمية الخاصة بالمحتوى الجديد.", "Free access to general announcements, research updates, and some educational signals or alerts for new content."],
    ["تحديثات عامة حول الأبحاث والإشارات والفيديوهات", "General updates around research, signals, and videos"],
    ["لوحة الأبحاث والإشارات", "Research and Signals Dashboard"],
    ["خطة الأبحاث والإشارات", "Research and Signals Plan"],
    ["وصول إلى لوحة الأبحاث والإشارات التعليمية، مكتبة الفيديو، وسجل القراءات حسب الأسواق التي تختارها. يتم تفعيل الحساب عبر تيليجرام.", "Access to the research-and-signals dashboard, video library, and market readings for the markets you choose. Account activation is handled through Telegram."],
    ["وصول إلى لوحة الأبحاث والإشارات، مكتبة الفيديو، وسجل القراءات حسب الأسواق التي تختارها. يتم تفعيل الحساب عبر تيليجرام.", "Access to the research-and-signals dashboard, video library, and market readings for the markets you choose. Account activation is handled through Telegram."],
    ["إشارات وقراءات حسب السوق", "Signals and readings by market"],
    ["المحتوى العام، بما في ذلك الأبحاث والإشارات التعليمية والفيديوهات، لأغراض بحثية وتعليمية فقط ولا يمثل نصيحة استثمارية أو ضماناً للعوائد. إدارة المحافظ خدمة منفصلة قد تشمل نصيحة استثمارية بعد اتفاق مكتوب.", "Public content, including research, educational signals, and videos, is for research and education only and is not investment advice or a return guarantee. Portfolio management is a separate service that may include investment advice after a written agreement."],
    ["اطلب الوصول إلى الأبحاث والإشارات والفيديو", "Request access to research, signals, and video"],
    ["تواصل معي | عبدالرحمن محمد", "Contact Me | Abdulrhman Mohamed"],
    ["تواصل مع عبدالرحمن محمد لحجز جلسة 1v1 أو الاستفسار عن لوحة الأبحاث والإشارات التعليمية وإدارة مخاطر المحافظ.", "Contact Abdulrhman Mohamed to book a 1v1 session or ask about the research-and-signals dashboard and portfolio risk management."],
    ["اختر القناة المناسبة لاستفسارك. جلسات 1v1 المدفوعة مخصصة للتدريب والتحليل ومراجعة الإشارات أو طريقة العمل، أما مكالمة إدارة المحفظة المجانية فهي لتقييم النطاق قبل أي اتفاق.", "Select the appropriate channel for your inquiry. Paid 1v1 sessions are for coaching, analysis, and reviewing signals or workflow, while the free portfolio-management call is for scoping the mandate before any agreement."],
    ["تواصل مباشرة لتفعيل لوحة الأبحاث والإشارات، أسئلة الاشتراك، الوصول للحساب، أو المواد التعليمية والبحثية المنشورة.", "Message directly for research-and-signals dashboard activation, subscription questions, account access, or published educational and research material."],
    ["الأبحاث والإشارات", "Research and Signals"],
    ["إدارة المحتوى", "Content Management"],
    ["نشر وتعديل وحذف الأبحاث والإشارات", "Publish, edit, and delete research and signals"],
    ["هذه اللقطة للمتابعة البحثية والإشارات التعليمية فقط وليست توصية تداول أو استثمار.", "This snapshot is for research monitoring and educational signals only; it is not a trading or investment recommendation."],
    ["ملاحظة: هذا عرض تجريبي لأغراض بحثية وتعليمية، بما في ذلك الإشارات أو التنبيهات التعليمية، ولا يُعد توصية تداول أو نصيحة استثمارية.", "Note: this is a demo for research and educational purposes, including educational signals or alerts, and is not trading advice or investment advice."]
  ];
