(function () {
  ...
  var entries = [
    ...
    ["تواصل مباشرة لتفعيل لوحة الأبحاث، أسئلة الاشتراك، الوصول للحساب، أو المواد البحثية المنشورة.", "Message directly for research dashboard activation, subscription questions, account access, or published research material."],
    ...
    ["ابدأ من مجتمع تيليجرام المجاني، أو اطلب لوحة الأبحاث عبر تيليجرام، أو احجز جلسة 1v1 بسعر 50 دولار للساعة، أو مكالمة مجانية لمدة 20 دقيقة لمناقشة إدارة محفظة.", "Start with the free Telegram community, request the research dashboard through Telegram, book a 1v1 session at $50/hour, or schedule a free 20-minute call to discuss portfolio management."],
    ["مجاني", "Free"],
    ...
    ["لوحة الأبحاث", "Research Dashboard"],
    ["خطة لوحة الأبحاث", "Research Dashboard Plan"],
    ["وصول إلى لوحة الأبحاث، مكتبة الفيديو، وسجل القراءات حسب الأسواق التي تختارها. يتم تفعيل الحساب عبر تيليجرام.", "Access the research dashboard, video library, and market readings for the markets you choose. Account activation is handled through Telegram."],
    ...
    ["اختر بين الوصول إلى لوحة الأبحاث أو نطاق متابعة المحفظة. التسعير النهائي يعتمد على الأسواق، عدد الأدوات، وتكرار المراجعة المطلوبة.", "Choose between research dashboard access or a portfolio-management scope. Final pricing depends on markets, number of tools, and required review cadence."],
