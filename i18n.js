(function () {
  ...
  var entries = [
    ...
    ["اختر القناة المناسبة لاستفسارك. مكالمات 1v1 مخصصة للأسئلة والمنهجية، ومكالمات إدارة المحفظة مخصصة لمناقشة رأس المال، نسبة الاتفاق، الاستراتيجية، وحدود المخاطر قبل أي التزام.", "Select the appropriate channel for your inquiry. 1v1 calls are for questions and methodology, while portfolio-management calls are for discussing capital, fee percentage, strategy, and risk limits before any commitment."],
    ["حجز مكالمة", "Schedule a Call"],
    ["مكالمة خاصة لمناقشة أهدافك البحثية أو نطاق إدارة المحفظة. استشارة 1v1 بسعر 50 دولار لكل ساعة، أما إدارة المحفظة فتحدد بعد مناقشة رأس المال ونسبة الاتفاق والاستراتيجية والمخاطر.", "A private call to discuss your research objectives or portfolio-management scope. A 1v1 consultation is $50 per hour; portfolio management is defined after discussing capital, fee percentage, strategy, and risk."],
    ...
    ["المحتوى العام لأغراض بحثية وتعليمية فقط ولا يمثل نصيحة استثمارية أو ضماناً للعوائد. أي إدارة محفظة تتم فقط ضمن اتفاق خاص مكتوب بعد تحديد النطاق والمخاطر.", "Public content is for research and education only and is not investment advice or a return guarantee. Any portfolio management is handled only under a separate written agreement after scope and risk terms are defined."],
    ...
    ["ابدأ من مجتمع تيليجرام البحثي المجاني، أو اطلب تفعيل لوحة الأبحاث عبر تيليجرام، أو احجز مكالمة 1v1، أو ناقش إدارة محفظة منفصلة بشروط واضحة.", "Start with the free Telegram Research Community, request research dashboard activation through Telegram, book a 1v1 call, or discuss a separately scoped portfolio-management agreement."],
    ["مجاني", "Free"],
    ...
    ["مسار خاص يبدأ بمكالمة لمناقشة رأس المال، نسبة الاتفاق، الاستراتيجية، حدود المخاطر، وطريقة المتابعة قبل أي التزام.", "A private path that starts with a call to discuss capital, fee percentage, strategy, risk limits, and follow-up method before any commitment."],
    ["مناقشة رأس المال ونسبة الاتفاق", "Discuss capital and fee percentage"],
    ["تحديد الاستراتيجية وحدود المخاطر", "Define strategy and risk limits"],
    ["نطاق متابعة وإدارة مكتوب قبل البدء", "Written management and follow-up scope before starting"],
    ["ناقش إدارة المحفظة", "Discuss Portfolio Management"],
