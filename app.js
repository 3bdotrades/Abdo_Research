/* 
  =========================================
  Platform: أبحاث وإشارات تعليمية (النموذج الكمي)
  File: app.js
          ...
          <div class="chat-msg ai-msg">
            ...
            <div class="chat-bubble">
              ...
              <ul>
                ...
                <li><strong>السياق المالي:</strong> يجب ربط القراءة بحالة الأداة مالياً وبسلوك السعر قبل اعتماد الفرضية.</li>
                <li><strong>التقييم الكمي:</strong> ملف المخاطرة إلى العائد يحتاج مراجعة ضمن حجم الصفقة أو المركز وحالة المحفظة ككل قبل أي قرار.</li>
              </ul>
              <p><em>ملاحظة: هذا عرض تجريبي لأغراض بحثية وتعليمية، بما في ذلك الإشارات أو التنبيهات التعليمية، ولا يُعد توصية تداول أو نصيحة استثمارية.</em></p>
            </div>
          </div>
        `;
