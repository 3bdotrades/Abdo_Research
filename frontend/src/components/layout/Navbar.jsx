      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2.5 font-bold text-lg text-white">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-400 to-brand-600 rounded-lg flex items-center justify-center shadow-lg shadow-brand-900/40">
              <span className="text-gray-950 font-black text-sm tracking-tight">AR</span>
            </div>
        ...
        <div className="md:hidden border-t border-gray-800 bg-gray-950 px-4 py-4 space-y-1">
          ...
          <div className="pt-3 border-t border-gray-800 flex flex-col gap-2">
            {user ? (
              ...
              <>
                <Link to="/login" onClick={() => setOpen(false)} className="btn-secondary text-sm">
                  Sign in
                </Link>
